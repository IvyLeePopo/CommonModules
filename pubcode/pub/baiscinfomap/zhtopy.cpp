...
ZhToPY::ZhToPY(QObject *parent) : QObject(parent)
{
    ...
    {
        qWarning() << QString::fromUtf8("failed to open :/zhtopy.txt");
        QString sFile = QCoreApplication::applicationDirPath() + "/data/zhtopy.txt";
