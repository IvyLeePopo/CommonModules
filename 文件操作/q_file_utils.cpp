...
QString FileUtils::md5(const QByteArray &data)
{
	QByteArray hash = QCryptographicHash::hash(data, QCryptographicHash::Md5);
	return hash.toHex();
}

QString FileUtils::getFileMd5Value(const QString &filePath)
{
...
bool FileUtils::moveFile(const QString &filePath, const QString &targetPath)
{
#ifdef Q_OS_WIN
...
bool FileUtils::copyFileToDir(const QString &filePath, const QString &targetDir)
{
...
bool FileUtils::readFileData(const QString &filePath, QByteArray &retData)
{
	QFile file(filePath);
...
QString FileUtils::renameAndCalcMd5(const QString &oldPath, const QString &newPath, bool isKeepOldFile)
{
	QString newMd5;
...
bool FileUtils::copyDirFileToDir(const QString &srcPath, const QString &dstPath, bool cover/* = false*/)
{
	QDir srcDir(srcPath);
	QDir dstDir(dstPath);
	if (!dstDir.exists())
...
bool FileUtils::getDirAllFiles(string strSuffix, string strDir, vector<tagFileInfo> &vecFiles)
{
