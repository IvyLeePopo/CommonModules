...
LWS_VISIBLE LWS_EXTERN const lws_humanize_unit_t humanize_schema_si[] = {0};
LWS_VISIBLE LWS_EXTERN const lws_humanize_unit_t humanize_schema_si_bytes[] = {0};
LWS_VISIBLE LWS_EXTERN const lws_humanize_unit_t humanize_schema_us[] = {0};
