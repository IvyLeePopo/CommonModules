...
protected:
    ...
    bool m_bAutoSave;                               // true auto save，false not save,default is true
    std::string m_Delimiter;                        //!< separator between key and value
    std::string m_Comment;                          //!< separator between value and comments
	std::map<std::string, std::string> m_Contents;  //!< extracted keys and values  
    map<string, _tagConfigInfo> m_mapNewWord;       // new keys
...
public:
    ...
    // modify keys
    template<class T> bool AddEx(const std::string& strKey, const T& in_value, std::string strComment = "");
...
template<class T>
bool Config::AddEx(const std::string& strKey, const T& in_value, std::string strComment)
{
    string strValue = T_as_string(in_value);
    ...
    Config::_tagConfigInfo info;
    info.strKey = strRealKey;
    info.strValue = strValue;
    info.strComment = m_Comment + strComment;
    m_mapNewWord[strKey] = info;
}
